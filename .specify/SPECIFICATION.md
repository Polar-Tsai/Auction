...
時間軸:
最後出價 → +1h → 新起標價 = 原起標價 - 10 元
最後出價 → +2h → 新起標價 = 原起標價 - 20 元
最後出價 → +3h → 新起標價 = 原起標價 - 30 元
...
最後出價 → +Nh → 新起標價 = 原起標價 - N*10 元

最低降價底線: 10 元
即若原起標價 - 累計降價幅度 < 10 元，則設為 10 元
```

**流標認定條件**:
```
若在最低起標價 (10 元) 後仍無人出價超過 1 小時 → 該商品流標
狀態變更為 "Unsold"
```
